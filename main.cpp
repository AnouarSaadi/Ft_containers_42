...
int main()
{
	std::cout << "********************** My vector **********************" << std::endl;
	{
		...
		v.push_back("str " + std::to_string(0));
		v.push_back("str " + std::to_string(1));
		std::cout <<v[0] << std::endl;
		v.push_back("str " + std::to_string(2));
		v.push_back("str " + std::to_string(3));
		v.push_back("str " + std::to_string(4));
		// v.push_back(11);
		// v.push_back(12);
		// v.push_back(13);
		// v.push_back(14);
